...
SELECT COUNT(*) FROM Pixar.Movies; -- 7 to 11
...
SELECT COUNT(*) FROM Pixar.BoxOffice; -- 7 to 9
...
SELECT id, title, director FROM Pixar.Movies
...
SELECT id, title, `year` FROM Pixar.Movies
...
SELECT COUNT(*) FROM Pixar.BoxOffice; -- 8 to 11
...
WHERE movie_id = 11; -- apaga ligação pelo id com a tabela BoxOffice;

DELETE FROM Movies
WHERE id = 11;  -- apaga filme WALL-E pelo id da tabela Movies;

-- Exercício 7 : Exclua da tabela Movies todos os filmes dirigidos por "Andrew Staton".
SELECT id, title FROM Pixar.Movies
WHERE director = 'Andrew Staton'; -- ids dos filmes

DELETE FROM BoxOffice 
WHERE movie_id IN (2 , 9); -- apaga ligação pelo ids com a tabela BoxOffice;

DELETE FROM Movies
WHERE id IN (2,9); -- apaga filmes do diretor Andrew Staton pelo id da tabela Movies;
